...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'T2_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$T2_vInit$0$0 ==.
	C$T2.C$131$0$0 ==.
;	../T2.C:131: void T2_vInit(void)
;	-----------------------------------------
;	 function T2_vInit
;	-----------------------------------------
_T2_vInit:
	...
	ar1 = 0x01
	C$T2.C$152$1$1 ==.
;	../T2.C:152: T2_T2LH       =  0x8AD0;       // load timer 2 reload/capture register low 
	mov	_T2_T2LH,#0xD0
	mov	(_T2_T2LH >> 8),#0x8A
	C$T2.C$155$1$1 ==.
;	../T2.C:155: T2_RC2LH      =  0x8AD0;       // load timer 2 reload/capture register low 
	mov	_T2_RC2LH,#0xD0
	mov	(_T2_RC2LH >> 8),#0x8A
	C$T2.C$157$1$1 ==.
;	../T2.C:157: T2_T2MOD      =  0x18;         // load timer 2 mode register
	mov	_T2_T2MOD,#0x18
	C$T2.C$165$1$1 ==.
;	../T2.C:165: TR2 = 1; //   start timer
	setb	_TR2
	C$T2.C$167$1$1 ==.
	XG$T2_vInit$0$0 ==.
	ret
