...
; This file was generated Fri Jun 17 16:10:09 2016
;--------------------------------------------------------
	.module current_management
...
;--------------------------------------------------------
	...
	.globl _ADC_CHCTR0
	.globl _ACC
	.globl _current_overflow_flg
	.globl _current_newValue_flg
	.globl _current_result
	.globl _current_isOverflow
	.globl _current_isNewValueStored
	.globl _current_getResult
	.globl _current_init
	.globl _current_resultInterruptCall
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BSEG    (BIT)
G$current_newValue_flg$0$0==.
_current_newValue_flg::
	.ds 1
G$current_overflow_flg$0$0==.
_current_overflow_flg::
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	.area GSFINAL (CODE)
	.area GSINIT  (CODE)
	G$current_resultInterruptCall$0$0 ==.
	C$current_management.c$9$1$1 ==.
;	../current_management.c:9: int current_result = 0;
	clr	a
	mov	_current_result,a
	mov	(_current_result + 1),a
	G$current_resultInterruptCall$0$0 ==.
	C$current_management.c$7$1$1 ==.
;	../current_management.c:7: bit current_newValue_flg = 0;
	clr	_current_newValue_flg
	G$current_resultInterruptCall$0$0 ==.
	C$current_management.c$8$1$1 ==.
;	../current_management.c:8: bit current_overflow_flg = 0;
	clr	_current_overflow_flg
;--------------------------------------------------------
; Home
;--------------------------------------------------------
	.area HOME    (CODE)
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'current_isOverflow'
;------------------------------------------------------------
;------------------------------------------------------------
	G$current_isOverflow$0$0 ==.
	C$current_management.c$11$0$0 ==.
;	../current_management.c:11: bit current_isOverflow(void){
;	-----------------------------------------
;	 function current_isOverflow
;	-----------------------------------------
_current_isOverflow:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
	C$current_management.c$12$1$1 ==.
;	../current_management.c:12: return current_overflow_flg;
	mov	c,_current_overflow_flg
	C$current_management.c$13$1$1 ==.
	XG$current_isOverflow$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_isNewValueStored'
;------------------------------------------------------------
;------------------------------------------------------------
	G$current_isNewValueStored$0$0 ==.
	C$current_management.c$15$1$1 ==.
;	../current_management.c:15: bit current_isNewValueStored(void){
;	-----------------------------------------
;	 function current_isNewValueStored
;	-----------------------------------------
_current_isNewValueStored:
	C$current_management.c$16$1$1 ==.
;	../current_management.c:16: return current_newValue_flg;
	mov	c,_current_newValue_flg
	C$current_management.c$17$1$1 ==.
	XG$current_isNewValueStored$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_getResult'
;------------------------------------------------------------
;------------------------------------------------------------
	G$current_getResult$0$0 ==.
	C$current_management.c$19$1$1 ==.
;	../current_management.c:19: int current_getResult(void){
;	-----------------------------------------
;	 function current_getResult
;	-----------------------------------------
_current_getResult:
	C$current_management.c$21$1$1 ==.
;	../current_management.c:21: return current_result;
	mov	dpl,_current_result
	mov	dph,(_current_result + 1)
	C$current_management.c$22$1$1 ==.
	XG$current_getResult$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_init'
;------------------------------------------------------------
;------------------------------------------------------------
	G$current_init$0$0 ==.
	C$current_management.c$24$1$1 ==.
;	../current_management.c:24: bit current_init(void){
;	-----------------------------------------
;	 function current_init
;	-----------------------------------------
_current_init:
	C$current_management.c$26$1$1 ==.
;	../current_management.c:26: asic_stopCLK();
	lcall	_asic_stopCLK
	C$current_management.c$27$1$1 ==.
;	../current_management.c:27: asic_reg(ASIC_REGISTER_CRA);
	mov	dpl,#0x01
	lcall	_asic_reg
	C$current_management.c$28$1$1 ==.
;	../current_management.c:28: asic_dir(ASIC_WRITE);
	mov	dpl,#0x00
	lcall	_asic_dir
	C$current_management.c$29$1$1 ==.
;	../current_management.c:29: asic_len(ASIC_LENG_CRA);
	mov	dpl,#0x11
	lcall	_asic_len
	C$current_management.c$30$1$1 ==.
;	../current_management.c:30: asic_datL(CRA_CRM_RSHL_RSHH|CRA_GN_50|CRA_OSF_4MHz|CRA_OSR_64|CRA_MM_4|CRA_CRN_1024);
	mov	dptr,#0x034A
	lcall	_asic_datL
	C$current_management.c$31$1$1 ==.
;	../current_management.c:31: asic_send();
	lcall	_asic_send
	C$current_management.c$33$1$1 ==.
;	../current_management.c:33: asic_dir(ASIC_READ);
	mov	dpl,#0x01
	lcall	_asic_dir
	C$current_management.c$34$1$1 ==.
;	../current_management.c:34: asic_send();
	lcall	_asic_send
	C$current_management.c$35$1$1 ==.
;	../current_management.c:35: if(asic_getDataL()!=(CRA_CRM_RSHL_RSHH|CRA_GN_50|CRA_OSF_4MHz|CRA_OSR_64|CRA_MM_4|CRA_CRN_1024)){
	lcall	_asic_getDataL
	mov	r2,dpl
	mov	r3,dph
	cjne	r2,#0x4A,00111$
	cjne	r3,#0x03,00111$
	sjmp	00102$
00111$:
	C$current_management.c$36$2$2 ==.
;	../current_management.c:36: return 1;
	setb	c
	ret
00102$:
	C$current_management.c$39$1$1 ==.
;	../current_management.c:39: asic_reg(ASIC_REGISTER_OPM);
	mov	dpl,#0x00
	lcall	_asic_reg
	C$current_management.c$40$1$1 ==.
;	../current_management.c:40: asic_dir(ASIC_WRITE);
	mov	dpl,#0x00
	lcall	_asic_dir
	C$current_management.c$41$1$1 ==.
;	../current_management.c:41: asic_len(ASIC_LENG_OPM);
	mov	dpl,#0x04
	lcall	_asic_len
	C$current_management.c$42$1$1 ==.
;	../current_management.c:42: asic_datL(0x0001);
	mov	dptr,#0x0001
	lcall	_asic_datL
	C$current_management.c$43$1$1 ==.
;	../current_management.c:43: asic_send();
	lcall	_asic_send
	C$current_management.c$44$1$1 ==.
;	../current_management.c:44: while(asic_isBusy());
00103$:
	lcall	_asic_isBusy
	jc	00103$
	C$current_management.c$45$1$1 ==.
;	../current_management.c:45: asic_startCLK();
	lcall	_asic_startCLK
	C$current_management.c$46$1$1 ==.
;	../current_management.c:46: return 0;
	clr	c
	C$current_management.c$47$1$1 ==.
	XG$current_init$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_resultInterruptCall'
;------------------------------------------------------------
;------------------------------------------------------------
	G$current_resultInterruptCall$0$0 ==.
	C$current_management.c$51$1$1 ==.
;	../current_management.c:51: void current_resultInterruptCall(void){
;	-----------------------------------------
;	 function current_resultInterruptCall
;	-----------------------------------------
_current_resultInterruptCall:
	C$current_management.c$54$1$1 ==.
;	../current_management.c:54: asic_reg(ASIC_REGISTER_MSR);
	mov	dpl,#0x04
	lcall	_asic_reg
	C$current_management.c$55$1$1 ==.
;	../current_management.c:55: asic_dir(ASIC_READ);
	mov	dpl,#0x01
	lcall	_asic_dir
	C$current_management.c$56$1$1 ==.
;	../current_management.c:56: asic_len(ASIC_LENG_MSR);
	mov	dpl,#0x12
	lcall	_asic_len
	C$current_management.c$57$1$1 ==.
;	../current_management.c:57: asic_send();
	lcall	_asic_send
	C$current_management.c$59$1$1 ==.
;	../current_management.c:59: current_result = 2.03*(asic_getDataL()+4); //get testresult
	lcall	_asic_getDataL
	mov	a,dpl
	mov	b,dph
	add	a,#0x04
	...
	mov	a,r5
	lcall	___fs2sint
	mov	_current_result,dpl
	mov	(_current_result + 1),dph
	C$current_management.c$60$1$1 ==.
;	../current_management.c:60: current_overflow_flg = asic_getDataH()&0x2; // ist 1
	lcall	_asic_getDataH
	mov	r2,dpl
	mov	a,r2
	mov	c,acc[1]
	mov	_current_overflow_flg,c
	C$current_management.c$61$1$1 ==.
;	../current_management.c:61: current_newValue_flg = 1; //Ein neuer wert wurde gespeichert
	setb	_current_newValue_flg
	C$current_management.c$63$1$1 ==.
	XG$current_resultInterruptCall$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
