...
__interrupt_vect:
	...
	ljmp	_UART_viIsr
	.ds	5
	ljmp	_SHINT_viXINTR5Isr
	.ds	5
	reti
	.ds	7
	reti
	.ds	7
	ljmp	_SHINT_viXINTR8Isr
	.ds	5
	reti
	.ds	7
	ljmp	_SHINT_viXINTR10Isr
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	.globl __xc800_genXINIT
	.globl __xc800_genXRAMCLEAR
	.globl __xc800_genRAMCLEAR
	.area GSFINAL (CODE)
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'MAIN_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$MAIN_vInit$0$0 ==.
	C$MAIN.C$122$0$0 ==.
;	../MAIN.C:122: void MAIN_vInit(void)
;	-----------------------------------------
;	 function MAIN_vInit
;	-----------------------------------------
_MAIN_vInit:
	...
	ar1 = 0x01
	C$MAIN.C$138$1$1 ==.
;	../MAIN.C:138: SFR_PAGE(_su1, noSST);         // switch to page1
	mov	_SCU_PAGE,#0x01
	C$MAIN.C$140$1$1 ==.
;	../MAIN.C:140: CMCON         =  0x10;         // load Clock Control Register
	mov	_CMCON,#0x10
	C$MAIN.C$142$1$1 ==.
;	../MAIN.C:142: SFR_PAGE(_su0, noSST);         // switch to page0
	mov	_SCU_PAGE,#0x00
	C$MAIN.C$151$1$1 ==.
;	../MAIN.C:151: IO_vInit();
	lcall	_IO_vInit
...
;	../MAIN.C:163: T2_vInit();
	lcall	_T2_vInit
	C$MAIN.C$166$1$1 ==.
;	../MAIN.C:166: T21_vInit();
	lcall	_T21_vInit
	C$MAIN.C$169$1$1 ==.
;	../MAIN.C:169: CC6_vInit();
	lcall	_CC6_vInit
	C$MAIN.C$172$1$1 ==.
;	../MAIN.C:172: CAN_vInit();
	lcall	_CAN_vInit
	C$MAIN.C$175$1$1 ==.
;	../MAIN.C:175: SHINT_vInit();
	lcall	_SHINT_vInit
	C$MAIN.C$179$1$1 ==.
;	../MAIN.C:179: IP            =  0x21;         // load Interrupt Priority Register
	mov	_IP,#0x21
	C$MAIN.C$180$1$1 ==.
;	../MAIN.C:180: IPH           =  0x01;         // load Interrupt Priority High Register
	mov	_IPH,#0x01
	C$MAIN.C$181$1$1 ==.
;	../MAIN.C:181: IP1           =  0x00;         // load Interrupt Priority 1 Register
	mov	_IP1,#0x00
	C$MAIN.C$182$1$1 ==.
;	../MAIN.C:182: IPH1          =  0x10;         // load Interrupt Priority 1 High Register
	mov	_IPH1,#0x10
	C$MAIN.C$191$1$1 ==.
;	../MAIN.C:191: SYSCON0 |= 0x10;
	orl	_SYSCON0,#0x10
	C$MAIN.C$197$1$1 ==.
;	../MAIN.C:197: EA            =  1;           
	setb	_EA
...
_main:
	C$MAIN.C$229$1$1 ==.
;	../MAIN.C:229: MAIN_vInit();
	lcall	_MAIN_vInit
	C$MAIN.C$232$1$1 ==.
;	../MAIN.C:232: if(current_init()==0){
	lcall	_current_init
	jc	00104$
	C$MAIN.C$233$2$2 ==.
;	../MAIN.C:233: IO_vTogglePin(P0_7);
	cpl	_P0_7
	C$MAIN.C$243$1$1 ==.
;	../MAIN.C:243: while(1)
00104$:
