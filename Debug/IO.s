...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'IO_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$IO_vInit$0$0 ==.
	C$IO.C$122$0$0 ==.
;	../IO.C:122: void IO_vInit(void)
;	-----------------------------------------
;	 function IO_vInit
;	-----------------------------------------
_IO_vInit:
	...
	ar1 = 0x01
	C$IO.C$160$1$1 ==.
;	../IO.C:160: P0_DIR        =  0x98;         // load direction register
	mov	_P0_DIR,#0x98
	C$IO.C$191$1$1 ==.
;	../IO.C:191: P1_DIR        =  0xC0;         // load direction register
	mov	_P1_DIR,#0xC0
	C$IO.C$220$1$1 ==.
	XG$IO_vInit$0$0 ==.
	ret
