...
;--------------------------------------------------------
	...
	.globl _ADC_CHCTR0
	.globl _ACC
	.globl _current_error01_counter
	.globl _current_error00_counter
	.globl _current_value_counter
	.globl _current_final_result
	.globl _current_sum
	.globl _current_evaluation
	.globl _save_act_current
	.globl _current_controller_soft_reset
	.globl _current_send_CAN_0x60
	.globl _current_send_CAN_0x70
;--------------------------------------------------------
...
_current_sum::
	.ds 4
G$current_final_result$0$0==.
_current_final_result::
	.ds 4
G$current_value_counter$0$0==.
_current_value_counter::
	.ds 2
G$current_error00_counter$0$0==.
_current_error00_counter::
	.ds 2
G$current_error01_counter$0$0==.
_current_error01_counter::
	.ds 2
Lcurrent_send_CAN_0x60$cur$1$1==.
_current_send_CAN_0x60_cur_1_1:
	.ds 4
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'current_evaluation'
;------------------------------------------------------------
;------------------------------------------------------------
...
;	../current_controller.c:50: current_final_result = current_sum/500;		//Mittelwert über die gemessenen Ströme ermitteln
	...
	mov	dpl,_current_sum
	mov	dph,(_current_sum + 1)
...
;	../current_controller.c:63: if(current_error00_counter == 5||current_error01_counter == 5){
	...
	clr	a
	cjne	a,(_current_error00_counter + 1),00130$
	sjmp	00111$
00130$:
	mov	a,#0x05
	cjne	a,_current_error01_counter,00131$
	clr	a
	cjne	a,(_current_error01_counter + 1),00131$
	sjmp	00132$
00131$:
	ret
00132$:
...
;------------------------------------------------------------
;Allocation info for local variables in function 'save_act_current'
;------------------------------------------------------------
...
;	../current_controller.c:73: current_sum += current;
	...
	mov	_current_sum,a
	mov	a,r3
	addc	a,(_current_sum + 1)
	mov	(_current_sum + 1),a
	mov	a,r4
	addc	a,(_current_sum + 2)
	mov	(_current_sum + 2),a
	mov	a,r5
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_controller_soft_reset'
;------------------------------------------------------------
;------------------------------------------------------------
...
;	../current_controller.c:81: current_value_counter = 0;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'current_send_CAN_0x60'
;------------------------------------------------------------
;current                   Allocated to registers r2 r3 
;cur                       Allocated with name '_current_send_CAN_0x60_cur_1_1'
