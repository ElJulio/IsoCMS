...
; This file was generated Fri Jun 17 14:55:25 2016
;--------------------------------------------------------
	.module INT
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'INT_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$INT_vInit$0$0 ==.
	C$INT.C$131$0$0 ==.
;	../INT.C:131: void INT_vInit(void)
;	-----------------------------------------
;	 function INT_vInit
;	-----------------------------------------
_INT_vInit:
	...
	ar1 = 0x01
	C$INT.C$151$1$1 ==.
;	../INT.C:151: NMICON        =  0x00;         //  NMI Control Register 
	mov	_NMICON,#0x00
	C$INT.C$157$1$1 ==.
;	../INT.C:157: IT0 = 0;
	clr	_IT0
	C$INT.C$168$1$1 ==.
;	../INT.C:168: IEN0          =  0x31;         //  interrupt enable  register 0
	mov	_IEN0,#0x31
	C$INT.C$169$1$1 ==.
;	../INT.C:169: IEN1          =  0x10;         //  interrupt enable register 1
	mov	_IEN1,#0x10
	C$INT.C$170$1$1 ==.
;	../INT.C:170: EXICON0       =  0x00;         // external interrupt trigger select 
	mov	_EXICON0,#0x00
	C$INT.C$172$1$1 ==.
;	../INT.C:172: EXICON1       =  0x00;         // external interrupt trigger select 
	mov	_EXICON1,#0x00
	C$INT.C$174$1$1 ==.
;	../INT.C:174: MODPISEL      =  0x00;         // peripheral input select register 
	mov	_MODPISEL,#0x00
	C$INT.C$179$1$1 ==.
	XG$INT_vInit$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'INT_viExt0'
;------------------------------------------------------------
;------------------------------------------------------------
	G$INT_viExt0$0$0 ==.
	C$INT.C$216$1$1 ==.
;	../INT.C:216: void INT_viExt0(void) interrupt EXT0INT
;	-----------------------------------------
;	 function INT_viExt0
;	-----------------------------------------
_INT_viExt0:
	...
	mov	psw,#0x00
	C$INT.C$224$2$2 ==.
;	../INT.C:224: pushsyscon();                  // push the current RMAP
	 push 0x8F 
	C$INT.C$225$1$1 ==.
;	../INT.C:225: RESET_RMAP();                  // resets RMAP
	anl	_SYSCON0,#0xFE
	C$INT.C$227$1$1 ==.
;	../INT.C:227: SFR_PAGE(_su0, SST3);          // switch to page0
	mov	_SCU_PAGE,#0xB0
	C$INT.C$228$1$1 ==.
;	../INT.C:228: IRCON0 &= ~(ubyte)0x01; //   clear EXINT0
	anl	_IRCON0,#0xFE
	C$INT.C$232$1$1 ==.
;	../INT.C:232: current_resultInterruptCall();
	lcall	_current_resultInterruptCall
	C$INT.C$243$1$1 ==.
;	../INT.C:243: SFR_PAGE(_su0, RST3);          // restore the old SCU page
	mov	_SCU_PAGE,#0xF0
	C$INT.C$245$2$3 ==.
;	../INT.C:245: popsyscon();                   // restore the old RMAP
	 pop 0x8F 
	pop	psw
	pop	(0+1)
	pop	(0+0)
