...
; This file was generated Fri Jun 17 14:53:16 2016
;--------------------------------------------------------
	.module CC6
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'CC6_vInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$CC6_vInit$0$0 ==.
	C$CC6.C$122$0$0 ==.
;	../CC6.C:122: void CC6_vInit(void)
;	-----------------------------------------
;	 function CC6_vInit
;	-----------------------------------------
_CC6_vInit:
	...
	ar1 = 0x01
	C$CC6.C$128$1$1 ==.
;	../CC6.C:128: SFR_PAGE(_cc1, noSST);         // switch to page 1
	mov	_CCU6_PAGE,#0x01
	C$CC6.C$134$1$1 ==.
;	../CC6.C:134: CCU6_TCTR0L    =  0x00;        // load CCU6 timer control register 0 low
	mov	_CCU6_TCTR0L,#0x00
	C$CC6.C$135$1$1 ==.
;	../CC6.C:135: CCU6_TCTR0H    =  0x00;        // load CCU6 timer control register 0 high
	mov	_CCU6_TCTR0H,#0x00
	C$CC6.C$148$1$1 ==.
;	../CC6.C:148: CCU6_T12PRL    =  0x02;        // load CCU6 T12 period register low
	mov	_CCU6_T12PRL,#0x02
	C$CC6.C$149$1$1 ==.
;	../CC6.C:149: CCU6_T12PRH    =  0x00;        // load CCU6 T12 period register lhigh
	mov	_CCU6_T12PRH,#0x00
	C$CC6.C$162$1$1 ==.
;	../CC6.C:162: CCU6_T13PRL    =  0x01;        // load CCU6 T13 period register low
	mov	_CCU6_T13PRL,#0x01
	C$CC6.C$163$1$1 ==.
;	../CC6.C:163: CCU6_T13PRH    =  0x00;        // load CCU6 T13 period register high
	mov	_CCU6_T13PRH,#0x00
	C$CC6.C$169$1$1 ==.
;	../CC6.C:169: CCU6_T12DTCL   =  0x01;        // load CCU6 dead time control register low 
	mov	_CCU6_T12DTCL,#0x01
	C$CC6.C$172$1$1 ==.
;	../CC6.C:172: CCU6_T12DTCH   =  0x00;        // load CCU6 dead time control register high 
	mov	_CCU6_T12DTCH,#0x00
	C$CC6.C$175$1$1 ==.
;	../CC6.C:175: SFR_PAGE(_cc0, noSST);         // switch to page 0
	mov	_CCU6_PAGE,#0x00
	C$CC6.C$201$1$1 ==.
;	../CC6.C:201: CCU6_CC62SRL   =  0x01;        // load CCU6 capture/compare shadow register 
	mov	_CCU6_CC62SRL,#0x01
	C$CC6.C$203$1$1 ==.
;	../CC6.C:203: CCU6_CC62SRH   =  0x00;        // load CCU6 capture/compare shadow register 
	mov	_CCU6_CC62SRH,#0x00
	C$CC6.C$213$1$1 ==.
;	../CC6.C:213: CCU6_CC63SRL   =  0x00;        // load CCU6 capture/compare shadow register 
	mov	_CCU6_CC63SRL,#0x00
	C$CC6.C$215$1$1 ==.
;	../CC6.C:215: CCU6_CC63SRH   =  0x00;        // load CCU6 capture/compare shadow register 
	mov	_CCU6_CC63SRH,#0x00
	C$CC6.C$223$1$1 ==.
;	../CC6.C:223: CCU6_MCMOUTSL  =  0x00;        // load CCU6 multi channel mode output 
	mov	_CCU6_MCMOUTSL,#0x00
	C$CC6.C$225$1$1 ==.
;	../CC6.C:225: CCU6_MCMOUTSH  =  0x00;        // load CCU6 multi channel mode output 
	mov	_CCU6_MCMOUTSH,#0x00
	C$CC6.C$228$1$1 ==.
;	../CC6.C:228: SFR_PAGE(_cc2, noSST);         // switch to page 2
	mov	_CCU6_PAGE,#0x02
	C$CC6.C$234$1$1 ==.
;	../CC6.C:234: CCU6_TCTR2L    =  0x00;        // load CCU6 timer control register 2 low
	mov	_CCU6_TCTR2L,#0x00
	C$CC6.C$235$1$1 ==.
;	../CC6.C:235: CCU6_TCTR2H    =  0x00;        // load CCU6 timer control register 2 high
	mov	_CCU6_TCTR2H,#0x00
	C$CC6.C$247$1$1 ==.
;	../CC6.C:247: CCU6_TRPCTRL   =  0x00;        // load CCU6 trap control register low
	mov	_CCU6_TRPCTRL,#0x00
	C$CC6.C$248$1$1 ==.
;	../CC6.C:248: CCU6_TRPCTRH   =  0x00;        // load CCU6 trap control register high
	mov	_CCU6_TRPCTRH,#0x00
	C$CC6.C$255$1$1 ==.
;	../CC6.C:255: CCU6_MODCTRL   =  0x20;        // load CCU6 modulation control register low
	mov	_CCU6_MODCTRL,#0x20
	C$CC6.C$256$1$1 ==.
;	../CC6.C:256: CCU6_MODCTRH   =  0x00;        // load CCU6 modulation control register high
	mov	_CCU6_MODCTRH,#0x00
	C$CC6.C$262$1$1 ==.
;	../CC6.C:262: CCU6_MCMCTR    =  0x00;        // load CCU6 multi channel mode control 
	mov	_CCU6_MCMCTR,#0x00
	C$CC6.C$269$1$1 ==.
;	../CC6.C:269: CCU6_T12MSELL  =  0x00;        // load CCU6 T12 campture/compare mode 
	mov	_CCU6_T12MSELL,#0x00
	C$CC6.C$272$1$1 ==.
;	../CC6.C:272: CCU6_T12MSELH  =  0x02;        // load CCU6 T12 campture/compare mode 
	mov	_CCU6_T12MSELH,#0x02
	C$CC6.C$278$1$1 ==.
;	../CC6.C:278: CCU6_PSLR      =  0x00;        // load CCU6 passive state level register low
	mov	_CCU6_PSLR,#0x00
	C$CC6.C$291$1$1 ==.
;	../CC6.C:291: CCU6_INPL      =  0x00;        // load CCU6 capture/compare interrupt node 
	mov	_CCU6_INPL,#0x00
	C$CC6.C$293$1$1 ==.
;	../CC6.C:293: CCU6_INPH      =  0x00;        // load CCU6 capture/compare interrupt node 
	mov	_CCU6_INPH,#0x00
	C$CC6.C$296$1$1 ==.
;	../CC6.C:296: CCU6_IENL      =  0x00;        // load CCU6 capture/compare interrupt 
	mov	_CCU6_IENL,#0x00
	C$CC6.C$298$1$1 ==.
;	../CC6.C:298: CCU6_IENH      =  0x00;        // load CCU6 capture/compare interrupt 
	mov	_CCU6_IENH,#0x00
	C$CC6.C$301$1$1 ==.
;	../CC6.C:301: SFR_PAGE(_cc3, noSST);         // switch to page 3
	mov	_CCU6_PAGE,#0x03
	C$CC6.C$307$1$1 ==.
;	../CC6.C:307: CCU6_CMPSTATH  =  0x20;        // load CCU6 compare status register high
	mov	_CCU6_CMPSTATH,#0x20
	C$CC6.C$317$1$1 ==.
;	../CC6.C:317: CCU6_PISEL0L   =  0x00;        // load CCU6 Port Input Select Register 0 Low
	mov	_CCU6_PISEL0L,#0x00
	C$CC6.C$324$1$1 ==.
;	../CC6.C:324: CCU6_PISEL0H   =  0x00;        // load CCU6 Port Input Select Register 0 
	mov	_CCU6_PISEL0H,#0x00
	C$CC6.C$329$1$1 ==.
;	../CC6.C:329: CCU6_PISEL2    =  0x00;        // load CCU6 Port Input Select Register 2
	mov	_CCU6_PISEL2,#0x00
	C$CC6.C$334$1$1 ==.
;	../CC6.C:334: SFR_PAGE(_pp2, noSST);         // switch to page 2
	mov	_PORT_PAGE,#0x02
	C$CC6.C$336$1$1 ==.
;	../CC6.C:336: P3_ALTSEL0      |= 0x20;    //  set AltSel0 
	orl	_P3_ALTSEL0,#0x20
	C$CC6.C$337$1$1 ==.
;	../CC6.C:337: P3_ALTSEL1      &= ~(ubyte)0x20;    //  set AltSel1
	anl	_P3_ALTSEL1,#0xDF
	C$CC6.C$339$1$1 ==.
;	../CC6.C:339: SFR_PAGE(_pp0, noSST);         // switch to page 0
	mov	_PORT_PAGE,#0x00
	C$CC6.C$340$1$1 ==.
;	../CC6.C:340: P3_DIR          |= 0x20;    //  set Direction as Output
	orl	_P3_DIR,#0x20
	C$CC6.C$354$1$1 ==.
;	../CC6.C:354: SFR_PAGE(_cc0, noSST);         // switch to page 0
	mov	_CCU6_PAGE,#0x00
	C$CC6.C$361$1$1 ==.
;	../CC6.C:361: CCU6_TCTR4L    =  0x40;        // load CCU6 timer control register 4 low
	mov	_CCU6_TCTR4L,#0x40
	C$CC6.C$363$1$1 ==.
;	../CC6.C:363: CCU6_TCTR4H    =  0x40;        // load CCU6 timer control register 4 high
	mov	_CCU6_TCTR4H,#0x40
	C$CC6.C$369$1$1 ==.
	XG$CC6_vInit$0$0 ==.
	ret
	.area CSEG    (CODE)
